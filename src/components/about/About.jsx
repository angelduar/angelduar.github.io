    ...
    <div className="wrapper">
      ...
      <div className="content-container">
        ...
        <div className="container-text">
          ...
          <p> am a highly motivated and passionate learner as well as a flexible team player that enjoys working with people from diverse backgrounds. My goal is to make the world a better place by using technology as the driving force that will make this change possible.</p>
